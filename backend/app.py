...
app.config['MAIL_USERNAME'] = 'thats.a.real.spell@gmail.com' 
app.config['MAIL_PASSWORD'] = 'nzpqxnhvchmrujur'
app.config['MAIL_DEFAULT_SENDER'] = 'thats.a.real.spell@gmail.com'
